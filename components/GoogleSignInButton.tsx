...
// Shared by /admin/login and /login — same OAuth call, different `next`
// redirect target. Requires the Google provider to be enabled in the
// Supabase dashboard (Authentication -> Providers -> Google) with a Client
// ID/Secret from Google Cloud Console; nothing about that setup lives in
// app code or env vars, Supabase holds it server-side.
export default function GoogleSignInButton({
  ...
  return (
    <>
      <button className="btn btn-google" type="button" onClick={handleClick} disabled={isLoading}>
        <GoogleIcon />
