...
// RETIRED — full access is now sold as a monthly membership (see
// app/api/subscriptions/create/route.ts and components/UnlockContactCard.tsx,
// which no longer calls this route).
...
export async function POST() {
  return NextResponse.json(
    { error: "This is no longer available. Full access is now a monthly membership — see /opportunities." },
    { status: 410 },
  );
}
